...
## 🛠️ Descripción del Entorno y Herramientas

Esta práctica corresponde al **Taller Tema 5: Entorno de desarrollo, Git y GitHub**, enfocada en el dominio del flujo de trabajo estándar en desarrollo de software, control de versiones distribuido y trabajo colaborativo mediante ramas.

### Herramientas Utilizadas
- **Lenguaje de Programación:** Python 3.x (`python3`)
...
├── README.md        # Documentación del taller y entorno de desarrollo
└── app.py           # Script de prueba y verificación de ejecución (rama feature)
```

---

## 🚀 Ejecución del Script Base

Para ejecutar el script de verificación del entorno:
